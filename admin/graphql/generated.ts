...
export type SearchUsersQuery = { users: { total: number, users: Array<{ id: string, nickname: string, money: number, specialCoin: number, class: number, className: string, isVip: boolean, vipEternal: boolean, isInHospital: boolean, isInPrison: boolean, isWorking: boolean }> } };
