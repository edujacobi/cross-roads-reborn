...
export type InvestmentInfo = {
  ...
  henchmanEndsAt: Scalars['String']['output'];
  id: Scalars['Int']['output'];
  name: Scalars['String']['output'];
...
export type GetUserDetailQuery = { user: { id: string, nickname: string, money: number, avatarUrl: string | null, avatarDecoration: string, specialCoin: number, class: number, className: string, attack: number, defense: number, isVip: boolean, vipEternal: boolean, vipTime: string | null, language: string, isInHospital: boolean, hospitalTime: string | null, isInPrison: boolean, prisonTime: string | null, isWorking: boolean, jobEndsIn: string | null, isScavenging: boolean, isWanted: boolean, isInCasino: boolean, situationId: number, situationText: string, dailyStreak: number, voteCount: number, createdAt: string, updatedAt: string, gang: { id: number, name: string, imageUrl: string | null, color: string, level: number, role: string } | null, investment: { id: number, name: string, defense: number, expiresAt: string, nextPaymentValue: string, henchmanEndsAt: string } | null, items: Array<{ id: number, name: string, type: number, quantity: number, skin: number, remainingTime: string | null }>, badges: Array<{ id: number, name: string, description: string }> } | null };
