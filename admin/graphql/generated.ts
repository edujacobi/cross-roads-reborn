...
export type GetUserDetailQuery = { user: { id: string, nickname: string, money: number, avatarUrl: string | null, specialCoin: number, gangId: number | null, class: number, className: string, attack: number, defense: number, isVip: boolean, vipEternal: boolean, vipTime: string | null, language: string, isInHospital: boolean, hospitalTime: string | null, isInPrison: boolean, prisonTime: string | null, isWorking: boolean, jobEndsIn: string | null, isScavenging: boolean, isWanted: boolean, isInCasino: boolean, situationId: number, situationText: string, dailyStreak: number, voteCount: number, createdAt: string, updatedAt: string, investment: { id: number, name: string, defense: number, imageUrl: string, expiresAt: string } | null, items: Array<{ id: number, name: string, type: number, quantity: number, skin: number, remainingTime: string | null }>, badges: Array<{ id: number, name: string, description: string }> } | null };
