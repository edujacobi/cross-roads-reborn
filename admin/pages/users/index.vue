...
import { Search, ChevronLeft, ChevronRight, Eye, UserCheck } from "lucide-vue-next";
        ...
        <table class="users-table">
          ...
          <tbody>
            <tr v-for="u in users" :key="u.id">
              ...
              <td>
                <BaseBadge v-if="u.isInHospital" variant="danger">Hospital</BaseBadge>
                <BaseBadge v-else-if="u.isInPrison" variant="neutral">Prisão</BaseBadge>
                <BaseBadge v-else-if="u.isWorking" variant="warning">Trabalhando</BaseBadge>
                <BaseBadge v-else variant="success">Livre</BaseBadge>
              </td>
              <td>
                <BaseBadge v-if="u.vipEternal" variant="vip">Eterno</BaseBadge>
                <BaseBadge v-else-if="u.isVip" variant="vip">VIP</BaseBadge>
