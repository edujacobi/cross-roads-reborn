...
} = useQuery(GET_DASHBOARD_HISTORY);
  ...
  <div class="dashboard-page">
    <div class="page-title-row">
      ...
      <BaseButton variant="secondary" size="sm" @click="refreshData()">
        <RotateCw :size="15" :class="{ 'spin-icon': statsLoading || historyLoading }" />
        <span>Atualizar</span>
      </BaseButton>
    </div>
    ...
    <div class="details-row">
      <!-- Languages Card -->
      <BaseCard title="Distribuição por Idioma" class="language-card">
      ...
      <BaseCard title="Histórico Recente (Últimos 30 Dias)" class="history-card">
        ...
        <div v-else class="table-container">
          <table class="history-table">
            ...
            <tbody>
              <tr v-for="item in history" :key="item.id || item.date">
...
.status-grid {
  ...
  .status-box {
    ...
    &.danger {
      .status-box-header { color: $color-hospital; }
      border-left: 3px solid $color-hospital;
    }

    &.prison {
      .status-box-header { color: $color-prison; }
      border-left: 3px solid $color-prison;
    }

    &.warning {
      .status-box-header { color: $color-warning; }
      border-left: 3px solid $color-warning;
    }

    &.purple {
      .status-box-header { color: $color-vip; }
      border-left: 3px solid $color-vip;
    }

    &.orange {
      .status-box-header { color: #f97316; }
      border-left: 3px solid #f97316;
    }

    &.red {
      .status-box-header { color: $color-danger; }
  ...
  .history-card {
    ...
    .table-container {
      ...
      .history-table {
        ...
        .font-bold { font-weight: 700; color: $text-primary; }
        .text-danger { color: $color-hospital; }
        .text-prison { color: $color-prison; }
        .text-blue { color: lighten($color-working, 20%); }
